...
namespace OpenglLib
{
    public abstract class TextureFactory : IService, IDisposable
    {
        protected Dictionary<string, Texture> _cacheTexture = new Dictionary<string, Texture>();

        public virtual Task InitializeAsync() => Task.CompletedTask;
        public abstract Texture CreateTextureFromGuid(GL gl, string guid);
        public abstract Texture CreateTextureFromPath(GL gl, string texturePath);
