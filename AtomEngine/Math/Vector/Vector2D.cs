namespace AtomEngine.Math
{
    ...
    { 
        ...
        public static Vector2DInt operator *(Vector2DInt a, float b)
        {
            return new Vector2DInt((int)(a.X * b), (int)(a.Y * b));
        }
        ...
        //public Vector2DInt Normalized => this / Magnitude;

        public static float Dot(Vector2DInt a, Vector2DInt b)
        {
            return a.X * b.X + a.Y * b.Y;
        }

        public static float Distance(Vector2DInt a, Vector2DInt b)
        {
            return (a - b).Magnitude;
        }

        public static Vector2DInt Lerp(Vector2DInt a, Vector2DInt b, float t)
        {
            return a + (b - a) * t;
        }
