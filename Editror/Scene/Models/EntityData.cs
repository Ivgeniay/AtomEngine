...
namespace Editor
{
    internal class EntityData
    {
        ...
        public static EntityData CreateFromEntity(Entity entity, Dictionary<string, object> components) => new EntityData() { Id = entity.Id, Version = entity.Version, Components = components };
    }
}
